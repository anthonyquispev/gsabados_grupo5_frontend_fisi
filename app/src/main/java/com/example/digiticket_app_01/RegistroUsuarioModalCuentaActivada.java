...
public class RegistroUsuarioModalCuentaActivada extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registro_usuario_modal_cuenta_activada);
        ...
        btnAceptar = findViewById(R.id.btnAceptarModalCuentaActivada);
        //creando listener
        btnAceptar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //iniciando el activity
                startActivity(new Intent(RegistroUsuarioModalCuentaActivada.this, LoginCodigoUniversitario.class));
            }
        });
    }
}