...
public class MiPerfilEnviarComentariosModal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mi_perfil_enviar_comentarios_modal);
        ...
        btnAceptar = findViewById(R.id.btnAceptarEnviarComentarios);
        //creando listener
        btnAceptar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //iniciando el activity
                startActivity(new Intent(MiPerfilEnviarComentariosModal.this, MiPerfilPrincipal.class));
            }
        });
    }
}